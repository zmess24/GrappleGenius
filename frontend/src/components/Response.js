...
function Response({ title, summary }) {
	return (
		<section>
			...
			<p className="text-md leading-6 text-gray-600">{summary.overview}</p>
			<h3 className="text-xl font-bold tracking-tight text-gray-900 pb-3">Techniques</h3>
			{summary.techniques.map((technique, i) => {
				return (
					<section className="pb-5">
						<h4 className="text-md font-bold tracking-tight text-gray-900 pb-3">
